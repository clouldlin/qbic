				...
				<table width=95% border=0 cellspacing=0 cellpadding=0 align=center>
					<tr>
						<td><font size=2 color=#336699><br> <font
								...
								<p>
									<font size=2 color=#333366><b> <script
												type="text/javascript" src="http://jsgetip.appspot.com"></script>
							...
							</p> <font size=2 color=#FF0000><center>메시지ID :
									ERROR0304</center> </font></td>
					</tr>
				</table> <br>
			</td>
		</tr>
