...
public class CommonFileDAO extends EgovAbstractDAO {
	...
	public List<FileVO> selectFileByFileSn(FileVO vo) throws Exception {
	...
	public FileVO selectFileInf(FileVO vo) throws Exception {
		return (FileVO) selectByPk("FileManageDAO.selectFileInf", vo);
	}
	...
	public void deleteAllFileInf(FileVO vo) throws Exception {
		update("FileManageDAO.deleteCOMTNFILE", vo);
	}
	...
	public List<FileVO> selectFileListByFileNm(FileVO vo) throws Exception {
		return list("FileManageDAO.selectFileListByFileNm", vo);
	}
	...
	public int selectFileListCntByFileNm(FileVO vo) throws Exception {
		return (Integer) getSqlMapClientTemplate().queryForObject(
				"FileManageDAO.selectFileListCntByFileNm", vo);
	}
